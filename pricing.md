...
- Included: everything in Starter, plus double-entry accounting with
  ...
  multi-warehouse stock at moving average cost with counts, batches,
  expiry and returns; purchasing, suppliers, expenses and petty cash;
  shipping-line delivery orders with a demurrage clock; post-dated
  cheques with a maturity calendar; bank reconciliation; foreign currency
  with realised and unrealised differences; excise tax and its return
- Not included: payroll, projects, fixed assets, corporate tax
...
- Included: everything in Business, plus payroll runs, the WPS file and
  end-of-service gratuity; leave, balances, attendance and overtime;
  projects with progress billing, variation orders, retention and job
  costing; fixed assets and depreciation; corporate tax

## Beyond 25 users, or sector modules

Manufacturing work orders, service contracts, equipment hire, sales
...
- Data is isolated per company at the database level, not by an
  application filter.
- On leaving, customers receive a complete export of their data.

Contact: hello@faktra.ae
